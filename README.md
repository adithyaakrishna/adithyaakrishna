...
<details>
  ...
  - [ansible-collections/cloud.terraform](https://github.com/ansible-collections/cloud.terraform) - The collection automates the management and provisioning of infrastructure as code (IaC) using the Terraform CLI tool within Ansible playbooks and Execution Environment runtimes. (6 days ago)
  ...
  - [gensx-inc/gensx](https://github.com/gensx-inc/gensx) - The TypeScript framework for agents &amp; workflows with react-like components. Lightning fast dev loop. Easy to learn. Easy to extend. (1 week ago)
</details>
